// MODIFIED CODE SAMPLE 6.3 for ME333 HW5
// NOTE: LINES CHANGED INDICATED BY ***
...
int main(void) {
  ...
  IPC0bits.INT0IP = 0;               // step 4: clear 5 priority and subp bits for INT0 ***
  ...
  IPC1bits.INT1IP = 0;             // step 4: clear 5 priority and subp bits for INT1 ***
  ...
  IPC1bits.INT1IP = 0;               // step 4: set INT1 to priority 6 subpriority 0 ***
